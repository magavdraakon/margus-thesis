\chapter{Solution}
\label{solution}
\lettrine[lraise=0.1, nindent=0em, slope=-.5em]{\color{Violet}T}{he} Solution chapter is divided into four phases. First, the design phase for planning on learning process. Second, technical implementation of the e-learning course. Third, development phase where authoring of learning material being held. Fourth, the implementation phase the piloting of the course, where each course are run-through with particular students/trainers to get feedback about timing, content and evaluation.
...
{\color{red} TODO - the evaluation of design and development }
\begin{table}[h]
\centering
